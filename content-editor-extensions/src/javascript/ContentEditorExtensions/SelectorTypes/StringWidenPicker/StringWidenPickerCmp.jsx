...
const StringWidenPickerCmp = ({field, id, value, setActionContext, onChange}) => {
    console.log('[StringWidenPickerCmp] est dans la place !');
    console.log('[StringWidenPickerCmp] field',field);
    console.log('[StringWidenPickerCmp] field',id);
    console.log('[StringWidenPickerCmp] field',value);
    ...
    let context = {
        widen: {
            url: window.contextJsParameters.widen.url,//'https://api.widencollective.com',
            version: window.contextJsParameters.widen.version,//'v2',
            site: window.contextJsParameters.widen.site,//'virbac',
            token: window.contextJsParameters.widen.token,//'ba4d0a71907a17aff9ebddc1fc91fd3a',
            mountPoint:window.contextJsParameters.widen.mountPoint,
            lazyLoad:false,
            resultPerPage:20
        },
